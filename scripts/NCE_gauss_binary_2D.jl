...
"""
function Gaussianlogpdf(u::Matrix{Float64}, μ::Vector{Float64}, A::Matrix{Float64}, c::Vector{Float64})
...
variance σ and normalization constant c. Note that σ should be greater than 0.
"""
function G(u::Matrix{Float64}, μ::Vector{Float64}, A::Matrix{Float64}, c::Vector{Float64})
...
variance σ and normalization constant c. Note that σ should be greater than 0.
"""
function h(u::Matrix{Float64}, μ::Vector{Float64}, A::Matrix{Float64}, c::Vector{Float64})
    h = 1 ./ (1 .+ exp.(-G(u, μ, A, c)))
    return h
end
...
function loss_binary(x::Matrix{Float64}, y::Matrix{Float64})
