...
plot(α, mean(H, dims=2), lw=3, color=:blue, xlabel=L"$\alpha$", ylabel="Prediction Error", label="Testing data",
xtickfont=font(11), 
    ytickfont=font(11),
    guidefont=font(14),
    legendfont=font(11),
	legend=:left	)
plot!(α, mean(E, dims=2), color=:red, lw=3, label="Training data", title="Tiger",)
