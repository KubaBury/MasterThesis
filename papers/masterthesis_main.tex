...
In general, prediction error evaluated on the training data for increasing model complexity approaches zero. On the other hand, prediction error evaluated on the testing data for increasing model complexity is (from certain point) increasing as well. The typical scenario is illustrated in Figure \ref{fig:Prediction_error}.
 \begin{figure}[h]
	\centering
	\includegraphics[width=16.0cm]{Images/TITLE/PE3.pdf}
...
\begin{figure}[h] 
	...
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau1.pdf} }}%
	\subfloat[Estimated model for $\tau=10$ and $s=11$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau10.pdf} }}%
	\
	\subfloat[Estimated model for $\tau=100$ and $s=11$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau100.pdf} }}%,
	\subfloat[Estimated model for $\tau=1000$ and $s=11$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau1000.pdf} }}%
	\
	\subfloat[Estimated model for $\tau=100000$ and $s=11$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau100000.pdf} }}%,
	\subfloat[Estimated model for $\tau=1000000$ and $s=11$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tau1000000.pdf} }}%
...
\begin{figure}[h]
	...
	{{\includegraphics[width=8.0cm]{Images/TITLE/n2.pdf} }}%
	\subfloat[Estimated model for $\tau=100$ and $s-1=4$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/n4.pdf} }}%
	\
	\subfloat[Estimated model for $\tau=100$ and $s-1=5$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/n5.pdf} }}%,
	\subfloat[Estimated model for $\tau=100$ and $s-1=6$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/n6.pdf} }}%
	\
	\subfloat[Estimated model for $\tau=100$ and $s-1=8$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/n8.pdf} }}%,
	\subfloat[Estimated model for $\tau=100$ and $s-1=10$.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/n10.pdf} }}%
...
\begin{figure}[h]
	...
	{{\includegraphics[width=8.0cm]{Images/TITLE/tikzit_image1} }}%
	\subfloat[Multiple instance learning]
	{{\includegraphics[width=8.0cm]{Images/TITLE/tikzit_image3} }}%
...
\begin{figure}[h]
	\centering
	\includegraphics[width=16.0cm, trim={4cm 4.0cm 0.5cm 3.5cm},clip]{Images/TITLE/nn.pdf}
...
\begin{figure}[h]
	...
	{{\includegraphics[width=8.0cm]{Images/TITLE/KFCV_Musk4.pdf} }}%
	\subfloat[CV for dataset Musk2.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/KFCV_Musk2.pdf} }}%
	\
	\subfloat[CV for dataset Fox.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/KFCV_Fox.pdf} }}%
	\subfloat[CV for dataset Tiger.]
	{{\includegraphics[width=8.0cm]{Images/TITLE/KFCV_Tiger.pdf} }}%
...
\begin{figure}[h]
	...
	{{\includegraphics[width=8.2cm]{Images/TITLE/HDGM_Musk3.pdf} }}%
	\subfloat[HDGM for dataset Musk2.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/HDGM_Musk4.pdf} }}%
	\
	\subfloat[HDGM for dataset Fox.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/HDGM_Fox.pdf} }}%
	\subfloat[HDGM for dataset Tiger.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/HDGM_Tiger.pdf} }}
...
\begin{figure}[h]
	...
	{{\includegraphics[width=8.2cm]{Images/TITLE/supervisedvsHDGM0_5_Musk1.pdf} }}%
	\subfloat[HDGM: $\alpha=0.5$ vs Discriminative; Musk2.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/supervisedvsHDGM0_5_Musk2.pdf} }}%
	\
	\subfloat[HDGM: $\alpha=0.5$ vs Discriminative; Fox.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/supervisedvsHDGM0_5_Fox.pdf} }}%
	\subfloat[HDGM: $\alpha=0.5$ vs Discriminative; Tiger.]
	{{\includegraphics[width=8.2cm]{Images/TITLE/supervisedvsHDGM0_5_Tiger.pdf} }}
